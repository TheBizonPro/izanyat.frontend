            ...
            <div class="col-2 me-4">
                <div class="list-group list-group-flush">
                    <a href="/my-company-profile" style="font-size:13px"
                        ...
                        данные</a>
                    <a href="/my-company" style="font-size:13px"
                        class="list-group-item list-group-item-action list-group-item-dark">Данные
                        организации</a>
                    <a href="/my-company-payouts" hidden id="company_bank_account" style="font-size:13px; margin-left: 12px;"
                        class="list-group-item list-group-item-action">Платежные системы</a>
                    <a href="/employees" id="employees-list" hidden style="font-size:13px" class="list-group-item list-group-item-action">Сотрудники</a>
                    <a href="/my-company-permissions" id="permissions-list" hidden style="font-size:13px"
