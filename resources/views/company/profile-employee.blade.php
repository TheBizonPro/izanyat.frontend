        ...
        <div class="row">
            <div class="col-2 me-4">
                <div class="list-group list-group-flush">
                    ...
                    <a style="font-size:13px" id="permissions-list"
                        class="list-group-item list-group-item-action mt-5">Вопрос-ответ</a>
                </div>
            </div>
            <div class="col">
                <employeecard :employeeid="Number('{{$employee_id}}')"></employeecard>
            </div>
            <employeeaddtoprojectmodal :employeeid="Number('{{$employee_id}}')"></employeeaddtoprojectmodal>
        </div>
    </div>
</div>
